      ...
      <div className="pt-6 md:pt-28 pb-24 flex-wrap md:flex justify-center  gap-10">
        ...
        <div className="w-72 shadow-lg p-5 rounded-md text-center bg-slate-50 dark:bg-[#28292a] mx-auto md:mx-0 transition-all duration-500" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
          <div className="rounded-md w-60 h-64 mx-auto hover:scale-105 transition-all duration-300">
            {
              loadingCat ? <CgSpinner size={90} className="animate-spin mx-auto absolute top-24 left-24" /> : <img src={catImg} alt="cat img" className="rounded-md w-60 h-64 object-cover" data-aos="zoom-out" data-aos-duration="1000" data-aos-once="true"/>
            }
          </div>
        ...
        <div className="w-72 shadow-lg p-5 rounded-md text-center bg-slate-50 dark:bg-[#28292a] mx-auto mt-10 md:mt-0 md:mx-0 transition-all duration-500"data-aos="fade-left" data-aos-duration="1000" data-aos-once="true">
          <div className="rounded-md w-60 h-64 mx-auto hover:scale-105 transition-all duration-300">
            {loadingDog ? <CgSpinner size={90} className="animate-spin mx-auto absolute top-24 left-24" /> : <img src={dogImg} alt="dog img"  className="rounded-md w-60 h-64 object-cover" data-aos="zoom-out" data-aos-duration="1000" data-aos-once="true"/>}
          </div>
